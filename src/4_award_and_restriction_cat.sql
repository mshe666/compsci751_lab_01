...
-- Table RESTRICTION_CATEGORY

insert into RESTRICTION_CATEGORY values  
            ('M','Australia');
insert into RESTRICTION_CATEGORY values  
            ('KT','Belgium');
insert into RESTRICTION_CATEGORY values  
...
insert into RESTRICTION values
            ('Yinshi Nan Nu',1994,'13','Argentina');
insert into RESTRICTION values
            ('Yinshi Nan Nu',1994,'14','Chile');
insert into RESTRICTION values
            ('Yinshi Nan Nu',1994,'S','Finland');
insert into RESTRICTION values
            ('Yinshi Nan Nu',1994,'6','Germany');
insert into RESTRICTION values
            ('Yinshi Nan Nu',1994,'12','Portugal');
insert into RESTRICTION values
            ('Yinshi Nan Nu',1994,'T','Spain');
insert into RESTRICTION values
